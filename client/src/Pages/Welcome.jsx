    ...
    return (
        <div className="min-h-screen bg-gray-100 flex items-center justify-center">
            <div className="bg-white p-8 rounded-xl shadow-2xl max-w-md w-full">
                <h2 className="text-3xl font-bold text-[#3A244A] mb-6">Welcome, {userData.firstName}!</h2>
                <p className="mb-4">
                ...
                <p className="mb-4">
                    <span className="font-semibold">Preferred Contact Mode:</span> {userData.contactMode}
                </p>
                <button
